...
export const DAILY_ENTRIES_2026: Record<string, DailyEntry> = {
  "2026-04-01": { date: "2026-04-01", ca_caisse: 2590, ca_b2b: 0, ca_soir: 466, pct_soir: 18, tickets_count: 34, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [{ id: "e1", category: "MP", label: "Boucher", amount: 1200 }, { id: "e2", category: "MP", label: "Courses", amount: 560 }, { id: "e3", category: "RH", label: "Othman", amount: 3000 }] },
  "2026-04-02": { date: "2026-04-02", ca_caisse: 1721, ca_b2b: 0, ca_soir: 378, pct_soir: 22, tickets_count: 21, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [{ id: "e4", category: "MP", label: "Poissonnier", amount: 890 }, { id: "e5", category: "MP", label: "Courses", amount: 340 }] },
  "2026-04-03": { date: "2026-04-03", ca_caisse: 3840, ca_b2b: 0, ca_soir: 691, pct_soir: 18, tickets_count: 45, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [{ id: "e6", category: "MP", label: "Boucher", amount: 1500 }, { id: "e7", category: "RH", label: "Ramzi", amount: 1426 }] },
  "2026-04-04": { date: "2026-04-04", ca_caisse: 1884, ca_b2b: 0, ca_soir: 452, pct_soir: 24, tickets_count: 26, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [{ id: "e8", category: "MP", label: "Courses", amount: 420 }, { id: "e9", category: "MP", label: "Eau", amount: 180 }] },
  "2026-04-05": { date: "2026-04-05", ca_caisse: 4271, ca_b2b: 0, ca_soir: 897, pct_soir: 21, tickets_count: 52, mouvement_caisse: 0, notes: "Samedi — service soir fort", source: "csv_import", expenses: [{ id: "e10", category: "MP", label: "Boucher", amount: 1800 }, { id: "e11", category: "MP", label: "Poissonnier", amount: 950 }, { id: "e12", category: "RH", label: "Noeman", amount: 2000 }] },
  "2026-04-06": { date: "2026-04-06", ca_caisse: 2320, ca_b2b: 0, ca_soir: 510, pct_soir: 22, tickets_count: 31, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [{ id: "e13", category: "MP", label: "Courses", amount: 380 }] },
  "2026-04-07": { date: "2026-04-07", ca_caisse: 1480, ca_b2b: 0, ca_soir: 296, pct_soir: 20, tickets_count: 19, mouvement_caisse: 0, notes: "", source: "csv_import", expenses: [] },
}
...
export const ACTION_ITEMS: ActionItem[] = [
  ...
  { id: "a7",  lever: "b2b",       title: "Créer catalogue événementiel B2B",           description: "Brochure PDF + landing page offres séminaires/repas d'affaires",         priority: "medium", deadline: "T2 2026", budget_min: 5000,  budget_max: 5000,  impact: "CA B2B +50%",                status: "todo" },
...
export const IMPORT_HISTORY: ImportRecord[] = [
  { id: "i1", filename: "ventes_07042026_120153.csv", imported_at: "2026-04-07T12:01:53", rows_processed: 892,  days_imported: 7,  date_range_start: "2026-04-01", date_range_end: "2026-04-07", ca_total: 18106, status: "success" },
  { id: "i2", filename: "ventes_02032026_090000.csv", imported_at: "2026-03-02T09:00:00", rows_processed: 2840, days_imported: 28, date_range_start: "2026-02-01", date_range_end: "2026-02-28", ca_total: 123472, status: "success" },
  { id: "i3", filename: "ventes_03022026_080000.csv", imported_at: "2026-02-03T08:00:00", rows_processed: 3100, days_imported: 31, date_range_start: "2026-01-01", date_range_end: "2026-01-31", ca_total: 213460, status: "success" },
]
